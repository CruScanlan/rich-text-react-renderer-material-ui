...
function nodeToReactComponent(node, options) {
    var renderNode = options.renderNode, renderMark = options.renderMark, renderText = options.renderText, classes = options.classes;
    if (richTextTypes_es5_1.isText(node)) {
        ...
        return renderNode[node.nodeType](node, children, classes);
    }
}
...
//# sourceMappingURL=rich-text-react-renderer-material-ui.es5.js.map
